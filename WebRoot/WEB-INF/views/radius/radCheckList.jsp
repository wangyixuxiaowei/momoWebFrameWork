...
<html>
	...
	<body>
			...
			<div class="row">
				...
				<div class="panel panel-primary panel-mo">
					<div class="panel-heading">
						RadCheck管理列表&nbsp;&nbsp;&nbsp;&nbsp;
						<mo:hasPermission code="/radius/checks/check/list" action="add">
						<a type="btn" class="btn btn-danger btn-sm btn-mo" href="<c:url value='/radius/checks/check/add'/>"> 添加记录 </a>
						</mo:hasPermission>
					</div>
					<div class="panel-body">
		...
		<script src="<c:url value='/js/self.radcheck.list.js'/>" type="text/javascript"></script>
	</body>
</html>
