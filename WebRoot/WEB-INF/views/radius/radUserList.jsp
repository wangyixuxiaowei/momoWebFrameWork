...
<html>
	...
	<body>
			...
			<div class="row">
				...
				<div class="panel panel-primary panel-mo">
					<div class="panel-heading">
						RadUser管理列表&nbsp;&nbsp;&nbsp;&nbsp;
						<mo:hasPermission code="/radius/raduser/list" action="add">
						<a type="btn" class="btn btn-danger btn-sm btn-mo" href="<c:url value='/radius/raduser/add'/>"> 添加记录 </a>
						</mo:hasPermission>
					</div>
					<div class="panel-body">
						<table class="table table-mo table-bordered table-hover">
							...
							<tbody>
								<tr class="non_show_tr warning"><td colspan="3" class="non_show_td">无查询记录</td></tr>
							</tbody>
						</table>
						<!--分页区域 start-->
		...
		<script src="<c:url value='/js/self.raduser.list.js'/>" type="text/javascript"></script>
	</body>
</html>
