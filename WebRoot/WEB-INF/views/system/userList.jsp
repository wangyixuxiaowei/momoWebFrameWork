...
<html>
	...
	<body>
			...
			<div class="row">
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										<label class="control-label col-md-3">登录名称</label>
										<div class="col-md-9">
											<input id="username" class="form-control placeholder-no-fix" autocomplete="off" placeholder="登录名称"/>
										</div>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										 ...
										 <div class="col-md-9">
										 	<input id="name" class="form-control placeholder-no-fix" autocomplete="off" placeholder="姓名"/>
										 </div>
									</div>
								</div>
								<div class="col-md-4">
				...
				<div class="panel panel-primary panel-mo">
					<div class="panel-heading">
						用户信息管理列表&nbsp;&nbsp;&nbsp;&nbsp;
						<mo:hasPermission code="/system/perms/user/list" action="add">
						<a type="btn" class="btn btn-danger btn-sm btn-mo" href="<c:url value='/system/perms/user/add'/>"> 添加一个用户 </a>
						</mo:hasPermission>
					</div>
					<div class="panel-body">
		...
		<script src="<c:url value='/js/self.user.list.js'/>" type="text/javascript"></script>
	</body>
</html>
